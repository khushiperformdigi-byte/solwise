    ...
    <div className="min-h-screen bg-[#FDFBF7] flex flex-col">
      ...
      >
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 lg:px-10 grid grid-cols-1 lg:grid-cols-12 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col items-center text-center max-w-xl mx-auto lg:mx-0">
            ...
            <h2 
              className="text-[42px] sm:text-[50px] md:text-[56px] leading-[1.05] font-normal mb-1.5"
              style={{ fontFamily: "'Cormorant Garamond', serif" }}
            >
              <span className="engrave-ink">About </span>
              <span className="engrave-green font-medium">Dr. Sachin Bansal</span>
            </h2>
            ...
            {/* Tagline Paragraph (Increased Size & Tight Spacing) */}
            <p 
              className="text-[18px] md:text-[20px] text-[#8C6621] tracking-wide leading-tight mb-1.5 font-medium italic max-w-lg"
              style={{ fontFamily: "'Lora', serif" }}
            >
              A beacon of light for those seeking clarity, peace, and purpose.
            </p>

            {/* Body Paragraph (Increased Size & Tight Spacing) */}
            <p 
              className="text-[14.5px] md:text-[15.5px] text-[#4A4235] tracking-wide leading-snug mb-2.5 max-w-lg font-light"
              style={{ fontFamily: "'Lora', serif" }}
            >
            ...
            <div className="w-full max-w-lg bg-[#FAF5EC]/90 backdrop-blur-sm border border-[#E3D5C1] rounded-xl px-4 py-2.5 shadow-sm mb-3">
              <div className="grid grid-cols-2 sm:grid-cols-4 divide-y sm:divide-y-0 sm:divide-x divide-[#E3D5C1] gap-y-2 sm:gap-y-0">
                ...
                <div className="flex flex-col items-center px-1.5 py-0.5 text-center">
                  ...
                  <span className="engrave-green text-[24px] md:text-[26px] font-bold leading-none" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
                    15+
                  </span>
                  <span className="text-[10px] text-[#5A5042] uppercase tracking-wider mt-0.5 font-medium" style={{ fontFamily: "'Lato', sans-serif" }}>
                    Years of Experience
                  </span>
                </div>
                ...
                <div className="flex flex-col items-center px-1.5 py-0.5 text-center">
                  ...
                  <span className="engrave-green text-[20px] md:text-[22px] font-bold leading-none" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
                    Thousands
                  </span>
                  <span className="text-[10px] text-[#5A5042] uppercase tracking-wider mt-0.5 font-medium" style={{ fontFamily: "'Lato', sans-serif" }}>
            ...
            <a 
              href="#journey" 
              className="inline-flex items-center gap-2 rounded-full bg-[#123A1A] hover:bg-[#0d2a13] text-[#F5EFE6] text-[10.5px] md:text-[11px] font-bold tracking-[0.2em] px-7 py-3 shadow-md border border-[#B88A2E]/70 transition-all duration-300 hover:scale-[1.03]"
              style={{ fontFamily: "'Lato', sans-serif" }}
            >
              DISCOVER MY JOURNEY
      ...
      >
        <div className="relative z-10 w-full max-w-5xl mx-auto px-6 flex flex-col items-center text-center">
          ...
          <div className="flex items-center justify-center gap-3 mb-2">
            ...
            <span className="text-[11.5px] md:text-[12.5px] tracking-[0.28em] text-[#A67B2A] uppercase font-semibold" style={{ fontFamily: "'Lato', sans-serif" }}>
              THE SACRED JOURNEY
            </span>
            <span className="w-10 h-[1px] bg-[#C49A45]/60"></span>
          </div>
          ...
          <p 
            className="text-[15px] md:text-[16.5px] text-[#4A4235] tracking-wide leading-relaxed mb-8 max-w-xl font-light"
            style={{ fontFamily: "'Lora', serif" }}
          >
          ...
          <div className="w-full grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-2 items-start justify-items-center mb-8 relative">
            
            {/* Step 1: AWAKEN */}
            <div className="flex flex-col items-center text-center max-w-[180px] relative w-full">
              <div className="h-16 w-16 rounded-full bg-gradient-to-b from-[#FFFDF8] to-[#F5EAD4] border border-[#E0D0B5] shadow-md flex items-center justify-center mb-3 group hover:scale-105 transition-transform">
                <svg viewBox="0 0 24 24" className="h-8 w-8 text-[#B88A2E]" fill="none" stroke="currentColor" strokeWidth="1.5">
                  <path d="M12 4C10 8 6 10 7 14C8 14 10 12 12 8C14 12 16 14 17 14C18 10 14 8 12 4Z" fill="#B88A2E" opacity="0.25" />
                  <path d="M12 4C10 8 6 10 7 14C8 14 10 12 12 8C14 12 16 14 17 14C18 10 14 8 12 4Z" />
                  <path d="M12 8C7 12 3 14 4 18C6 18 9 16 12 12C15 16 18 18 20 18C21 14 17 12 12 8Z" />
                </svg>
              </div>
              <h3 className="engrave-green font-lato text-[13px] font-bold tracking-[0.18em] uppercase mb-1">
                AWAKEN
              </h3>
              <p className="font-lora text-[11.5px] text-[#5A5042] leading-tight font-light">
            ...
            <div className="flex flex-col items-center text-center max-w-[180px] relative w-full">
              <div className="h-16 w-16 rounded-full bg-gradient-to-b from-[#FFFDF8] to-[#F5EAD4] border border-[#E0D0B5] shadow-md flex items-center justify-center mb-3 group hover:scale-105 transition-transform">
                <svg viewBox="0 0 24 24" className="h-7 w-7 text-[#B88A2E]" fill="none" stroke="currentColor" strokeWidth="1.5">
                  <ellipse cx="12" cy="18" rx="7" ry="2.5" fill="#B88A2E" opacity="0.2" />
            ...
            <div className="flex flex-col items-center text-center max-w-[180px] relative w-full">
              <div className="h-16 w-16 rounded-full bg-gradient-to-b from-[#FFFDF8] to-[#F5EAD4] border border-[#E0D0B5] shadow-md flex items-center justify-center mb-3 group hover:scale-105 transition-transform">
                <svg viewBox="0 0 24 24" className="h-7 w-7 text-[#B88A2E]" fill="none" stroke="currentColor" strokeWidth="1.5">
                  <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z" fill="#B88A2E" opacity="0.2" />
            ...
            <div className="flex flex-col items-center text-center max-w-[180px] relative w-full">
              <div className="h-16 w-16 rounded-full bg-gradient-to-b from-[#FFFDF8] to-[#F5EAD4] border border-[#E0D0B5] shadow-md flex items-center justify-center mb-3 group hover:scale-105 transition-transform">
                <svg viewBox="0 0 24 24" className="h-7 w-7 text-[#B88A2E]" fill="none" stroke="currentColor" strokeWidth="1.5">
                  <circle cx="12" cy="7" r="3" fill="#B88A2E" opacity="0.3" />
          ...
          <a 
            href="#journey" 
            className="inline-flex items-center gap-2 rounded-full bg-[#123A1A] hover:bg-[#0d2a13] text-[#C4A15A] text-[12px] md:text-[13px] font-medium tracking-[0.08em] px-8 py-3.5 shadow-sm border border-[#C4A15A]/70 transition-all duration-300 hover:scale-[1.03]"
            style={{ fontFamily: "'Lora', serif" }}
          >
      ...
      >
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 flex flex-col items-center text-center">
          ...
          {/* Tagline Description */}
          <p 
            className="text-[14.5px] md:text-[15.5px] text-[#5A5042] tracking-wide leading-relaxed mb-8 max-w-xl font-light"
            style={{ fontFamily: "'Lora', serif" }}
          >
          ...
          <div className="w-full flex flex-col gap-5 mb-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
              ...
              {/* Card 1 */}
              <div className="bg-white/65 hover:bg-white/80 border border-[#ebdcc5] rounded-2xl p-5 flex flex-col items-center text-center shadow-[0_4px_12px_-4px_rgba(212,153,66,0.08)] hover:shadow-[0_12px_24px_-8px_rgba(212,153,66,0.18)] transition-all duration-300 max-w-[285px] w-full mx-auto">
                <div className="h-16 w-16 rounded-full bg-gradient-to-b from-[#FFFDF8] to-[#F5EAD4] border border-[#E0D0B5] flex items-center justify-center mb-3.5 shadow-inner">
                  <svg viewBox="0 0 100 100" className="h-10 w-10 text-[#B88A2E]" fill="none" stroke="currentColor" strokeWidth="1.5">
                    <path d="M50 25 C45 45 35 50 38 65 C43 65 48 55 50 40 C52 55 57 65 62 65 C65 50 55 45 50 25 Z" fill="#B88A2E" opacity="0.15" />
                    <circle cx="50" cy="40" r="6" />
                    <path d="M50 46 C44 49 40 54 40 60 L60 60 C60 54 56 49 50 46 Z" />
                    <path d="M35 60 C35 55 40 55 43 57 M65 60 C65 55 60 55 57 57" strokeLinecap="round" />
                  </svg>
                </div>
                <h3 className="engrave-green font-cormorant text-[18px] font-bold mb-2 leading-snug">
                  Life Coaching<br />& Guidance
                </h3>
                <p className="font-lora text-[12px] text-[#5A5042] leading-relaxed font-light">
                  One-on-one guidance to bring clarity, purpose and direction to your life.
                </p>
                <div className="mt-auto pt-3">
                  <svg viewBox="0 0 24 24" className="h-3 w-3 text-[#B88A2E] opacity-70" fill="currentColor">
              ...
              <div className="bg-white/65 hover:bg-white/80 border border-[#ebdcc5] rounded-2xl p-5 flex flex-col items-center text-center shadow-[0_4px_12px_-4px_rgba(212,153,66,0.08)] hover:shadow-[0_12px_24px_-8px_rgba(212,153,66,0.18)] transition-all duration-300 max-w-[285px] w-full mx-auto">
                <div className="h-16 w-16 rounded-full bg-gradient-to-b from-[#FFFDF8] to-[#F5EAD4] border border-[#E0D0B5] flex items-center justify-center mb-3.5 shadow-inner">
                  <svg viewBox="0 0 100 100" className="h-10 w-10 text-[#B88A2E]" fill="currentColor">
                    <polygon points="50,25 62,55 50,75 38,55" fill="#E86B8A" opacity="0.3" stroke="#B88A2E" strokeWidth="1.5" />
                    <polygon points="40,35 50,60 40,75 30,60" fill="#D49942" opacity="0.25" stroke="#B88A2E" strokeWidth="1.5" />
                    <polygon points="60,35 70,60 60,75 50,60" fill="#B88A2E" opacity="0.25" stroke="#B88A2E" strokeWidth="1.5" />
                    <path d="M28,25 L32,25 M30,23 L30,27 M68,25 L72,25 M70,23 L70,27" stroke="#B88A2E" strokeWidth="1.5" strokeLinecap="round" />
                  </svg>
                </div>
                <h3 className="engrave-green font-cormorant text-[18px] font-bold mb-2 leading-snug">
              ...
              <div className="bg-white/65 hover:bg-white/80 border border-[#ebdcc5] rounded-2xl p-5 flex flex-col items-center text-center shadow-[0_4px_12px_-4px_rgba(212,153,66,0.08)] hover:shadow-[0_12px_24px_-8px_rgba(212,153,66,0.18)] transition-all duration-300 max-w-[285px] w-full mx-auto">
                <div className="h-16 w-16 rounded-full bg-gradient-to-b from-[#FFFDF8] to-[#F5EAD4] border border-[#E0D0B5] flex items-center justify-center mb-3.5 shadow-inner">
                  <svg viewBox="0 0 100 100" className="h-10 w-10 text-[#B88A2E]" fill="none" stroke="currentColor" strokeWidth="1.5">
                    ...
                    <circle cx="50" cy="40" r="5" fill="#B88A2E" opacity="0.8" />
                    <path d="M50 45 C44 48 42 53 42 62 L58 62 C58 53 56 48 50 45 Z" fill="#B88A2E" opacity="0.8" />
                  </svg>
                </div>
                <h3 className="engrave-green font-cormorant text-[18px] font-bold mb-2 leading-snug">
              ...
              <div className="bg-white/65 hover:bg-white/80 border border-[#ebdcc5] rounded-2xl p-5 flex flex-col items-center text-center shadow-[0_4px_12px_-4px_rgba(212,153,66,0.08)] hover:shadow-[0_12px_24px_-8px_rgba(212,153,66,0.18)] transition-all duration-300 max-w-[285px] w-full mx-auto">
                <div className="h-16 w-16 rounded-full bg-gradient-to-b from-[#FFFDF8] to-[#F5EAD4] border border-[#E0D0B5] flex items-center justify-center mb-3.5 shadow-inner">
                  <svg viewBox="0 0 100 100" className="h-10 w-10 text-[#B88A2E]" fill="none" stroke="currentColor" strokeWidth="1">
                    <circle cx="50" cy="50" r="25" strokeWidth="1.5" />
                    <line x1="25" y1="50" x2="75" y2="50" />
                    <line x1="50" y1="25" x2="50" y2="75" />
                    <text x="36" y="42" fontSize="10" fontFamily="serif" fontWeight="bold" fill="#B88A2E" textAnchor="middle">3</text>
                    <text x="50" y="42" fontSize="10" fontFamily="serif" fontWeight="bold" fill="#B88A2E" textAnchor="middle">1</text>
                    <text x="64" y="42" fontSize="10" fontFamily="serif" fontWeight="bold" fill="#B88A2E" textAnchor="middle">8</text>
                    <text x="36" y="54" fontSize="10" fontFamily="serif" fontWeight="bold" fill="#B88A2E" textAnchor="middle">7</text>
                    <text x="50" y="54" fontSize="10" fontFamily="serif" fontWeight="bold" fill="#B88A2E" textAnchor="middle">5</text>
                    <text x="64" y="54" fontSize="10" fontFamily="serif" fontWeight="bold" fill="#B88A2E" textAnchor="middle">2</text>
                    <text x="36" y="66" fontSize="10" fontFamily="serif" fontWeight="bold" fill="#B88A2E" textAnchor="middle">9</text>
                    <text x="50" y="66" fontSize="10" fontFamily="serif" fontWeight="bold" fill="#B88A2E" textAnchor="middle">6</text>
                    <text x="64" y="66" fontSize="10" fontFamily="serif" fontWeight="bold" fill="#B88A2E" textAnchor="middle">4</text>
                  </svg>
                </div>
                <h3 className="engrave-green font-cormorant text-[18px] font-bold mb-2 leading-snug">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 max-w-4xl mx-auto w-full justify-center">
              ...
              <div className="bg-white/65 hover:bg-white/80 border border-[#ebdcc5] rounded-2xl p-5 flex flex-col items-center text-center shadow-[0_4px_12px_-4px_rgba(212,153,66,0.08)] hover:shadow-[0_12px_24px_-8px_rgba(212,153,66,0.18)] transition-all duration-300 max-w-[285px] w-full mx-auto">
                <div className="h-16 w-16 rounded-full bg-gradient-to-b from-[#FFFDF8] to-[#F5EAD4] border border-[#E0D0B5] flex items-center justify-center mb-3.5 shadow-inner">
                  <svg viewBox="0 0 100 100" className="h-10 w-10 text-[#B88A2E]" fill="none" stroke="currentColor" strokeWidth="1.5">
                    ...
                    <polygon points="50,28 55,50 50,72 45,50" fill="#B88A2E" opacity="0.3" />
              ...
              <div className="bg-white/65 hover:bg-white/80 border border-[#ebdcc5] rounded-2xl p-5 flex flex-col items-center text-center shadow-[0_4px_12px_-4px_rgba(212,153,66,0.08)] hover:shadow-[0_12px_24px_-8px_rgba(212,153,66,0.18)] transition-all duration-300 max-w-[285px] w-full mx-auto">
                <div className="h-16 w-16 rounded-full bg-gradient-to-b from-[#FFFDF8] to-[#F5EAD4] border border-[#E0D0B5] flex items-center justify-center mb-3.5 shadow-inner">
                  <svg viewBox="0 0 100 100" className="h-10 w-10 text-[#B88A2E]" fill="none" stroke="currentColor" strokeWidth="1.5">
                    <path d="M50 20 C42 38 25 48 32 62 C38 62 45 48 50 30 C55 48 62 62 68 62 C75 48 58 38 50 20 Z" fill="#E86B8A" opacity="0.4" />
                    <path d="M50 30 C46 42 38 48 42 56 C46 56 48 50 50 38 C52 50 54 56 58 56 C62 48 54 42 50 30 Z" fill="#D49942" opacity="0.3" />
                    <circle cx="50" cy="53" r="3" fill="#FFF2A1" />
              ...
              <div className="bg-white/65 hover:bg-white/80 border border-[#ebdcc5] rounded-2xl p-5 flex flex-col items-center text-center shadow-[0_4px_12px_-4px_rgba(212,153,66,0.08)] hover:shadow-[0_12px_24px_-8px_rgba(212,153,66,0.18)] transition-all duration-300 max-w-[285px] w-full mx-auto">
                <div className="h-16 w-16 rounded-full bg-gradient-to-b from-[#FFFDF8] to-[#F5EAD4] border border-[#E0D0B5] flex items-center justify-center mb-3.5 shadow-inner">
                  <svg viewBox="0 0 100 100" className="h-10 w-10 text-[#B88A2E]" fill="none" stroke="currentColor" strokeWidth="1.5">
                    <path d="M50 30 A8 8 0 0 0 50 46 A8 8 0 0 0 50 30 Z" fill="#B88A2E" opacity="0.35" />
                    <path d="M50 48 C42 52 38 58 38 68 L62 68 C62 58 58 52 50 48 Z" fill="#B88A2E" opacity="0.35" />
          ...
          <a 
            href="#programs" 
            className="inline-flex items-center gap-2.5 rounded-full bg-[#123A1A] hover:bg-[#0d2a13] text-[#F5EFE6] text-[11px] md:text-[11.5px] font-bold tracking-[0.2em] px-8 py-3.5 shadow-md border border-[#B88A2E]/70 transition-all duration-300 hover:scale-[1.03]"
            style={{ fontFamily: "'Lato', sans-serif" }}
          >
            EXPLORE ALL PROGRAMS
            <svg viewBox="0 0 100 100" className="h-4.5 w-4.5 text-[#B88A2E]" fill="currentColor">
              <path d="M50 15 C42 32 25 42 32 55 C38 55 45 42 50 25 C55 42 62 55 68 55 C75 42 58 32 50 15 Z" fill="#D49942" />
              <path d="M50 25 C46 36 38 42 42 50 C46 50 48 44 50 32 C52 44 54 50 58 50 C62 42 54 36 50 25 Z" fill="#E86B8A" />
              <circle cx="50" cy="48" r="3" fill="#FFF2A1" />
            </svg>
          ...
          <div className="bg-white/70 backdrop-blur-md border border-[#ebdcc5] rounded-3xl p-6 md:p-10 shadow-[0_8px_30px_-6px_rgba(212,153,66,0.08)] flex flex-col gap-8 md:gap-10">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              ...
              <div className="lg:col-span-7 w-full">
                <div className="relative aspect-[16/10] w-full rounded-2xl overflow-hidden border border-[#E3D5C1] shadow-xl bg-black group">
                  ...
                  <div className="absolute bottom-16 left-6 right-6">
                    <p 
                      className="text-[18px] sm:text-[22px] text-[#FAF5EC] leading-tight drop-shadow-md font-light"
                      style={{ fontFamily: "'Cormorant Garamond', serif" }}
                    >
                      Your transformation begins<br />
                      when you turn <span className="italic">inward.</span>
                    </p>
                  </div>

                  {/* Custom Video Controls Bar */}
                  <div className="absolute bottom-0 inset-x-0 h-14 bg-black/40 backdrop-blur-xs border-t border-white/10 flex items-center justify-between px-4 text-white text-[11px] font-mono">
              ...
              <div className="lg:col-span-5 flex flex-col items-center text-center pl-0 lg:pl-4">
                ...
                {/* Description */}
                <p 
                  className="text-[13.5px] md:text-[14.5px] text-[#5A5042] tracking-wide leading-relaxed mb-5 max-w-md font-light"
                  style={{ fontFamily: "'Lora', serif" }}
                >
                ...
                <a 
                  href="#video" 
                  className="inline-flex items-center gap-2 rounded-full bg-[#123A1A] hover:bg-[#0d2a13] text-[#C4A15A] text-[10px] md:text-[10.5px] font-bold tracking-[0.2em] px-6 py-3 shadow-md border border-[#C4A15A]/70 transition-all duration-300 hover:scale-[1.03]"
                  style={{ fontFamily: "'Lato', sans-serif" }}
                >
            ...
            <div className="w-full border-t border-[#E3D5C1]/40 pt-6 grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-4 justify-items-center">
              ...
              <div className="flex flex-col items-center text-center max-w-[180px]">
                ...
                <h4 className="engrave-green font-lato text-[12.5px] font-bold uppercase tracking-wide mb-1">
                  Soulful Visuals
                </h4>
                <p className="font-lora text-[11px] text-[#5A5042] leading-tight font-light">
