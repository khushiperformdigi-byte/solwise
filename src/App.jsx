      ...
      >
        <div className="relative z-10 w-full max-w-5xl mx-auto px-6 flex flex-col items-center text-center">
          ...
          <div className="w-full grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-2 items-start justify-items-center mb-8 relative">
            ...
            {/* Step 1: AWAKEN */}
            <div className="flex flex-col items-center text-center max-w-[180px] relative w-full group">
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 flex flex-col items-center text-center">
          ...
          <div className="w-full flex flex-col gap-5 mb-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
              ...
              {/* Card 1 */}
              <div className="group bg-white/65 hover:bg-[#123A1A] border border-[#ebdcc5] hover:border-[#C4A15A]/35 rounded-2xl p-5 flex flex-col items-center text-center shadow-[0_4px_12px_-4px_rgba(212,153,66,0.08)] hover:shadow-[0_12px_32px_-8px_rgba(18,58,26,0.38)] transition-all duration-500 max-w-[285px] w-full mx-auto">
                ...
                <h3 className="engrave-green group-hover:[background-image:linear-gradient(to_right,#C4A15A,#C4A15A)] font-cormorant text-[18px] font-bold mb-2 leading-snug transition-all duration-300">
                  Life Coaching<br />& Guidance
                </h3>
                <p className="font-lora text-[12px] text-[#5A5042] group-hover:!text-[#FAF5EC] leading-relaxed font-light transition-colors duration-300">
          ...
          <a 
            href="#programs" 
            className="inline-flex items-center gap-2.5 rounded-full bg-[#123A1A] hover:bg-[#0d2a13] text-[#C4A15A] text-[11px] md:text-[11.5px] font-bold tracking-[0.2em] px-8 py-3.5 shadow-md border border-[#C4A15A]/70 transition-all duration-300 hover:scale-[1.03]"
            style={{ fontFamily: "'Lato', sans-serif" }}
          >
