          ...
          <div className="mx-auto flex max-w-6xl flex-col gap-4 px-5 py-5 sm:px-8 lg:flex-row lg:items-center lg:justify-between">
              ...
              {CATEGORIES.map((item) => {
                ...
                return (
                  <button
                    ...
                    className={`rounded-full px-3.5 py-1.5 text-[11px] font-semibold uppercase tracking-[0.14em] transition-all ${
                      active
            ...
            <label className="relative w-full max-w-xs lg:w-64">
              ...
              <input
                ...
                className="w-full rounded-full border border-[#E2D6C2] bg-[#FFFcf8] py-2 pr-4 pl-10 text-[14.5px] text-[#2C261E] outline-none placeholder:text-[#A39888] focus:border-[#C4A15A] focus:ring-2 focus:ring-[#C4A15A]/20"
                style={{ fontFamily: "'Cormorant Garamond', serif" }}
              />
                ...
                >
                  ...
                  <div className="flex flex-1 flex-col px-5 pt-4 pb-5">
                    <div className="mb-3 flex items-center justify-between gap-3">
                      ...
                      <span
                        className="text-[11px] text-[#7A7266] font-medium"
                        style={{ fontFamily: "'Montserrat', sans-serif" }}
                      >
                        {post.date}
                      </span>
                    ...
                    <h2
                      className="engrave-green mb-2 text-[21px] leading-snug font-semibold"
                      style={{ fontFamily: "'Cormorant Garamond', serif" }}
                    >
                      {post.title}
                    </h2>
                    <p
                      className="mb-4 flex-1 text-[15px] leading-relaxed text-[#5C5348] font-normal"
                      style={{ fontFamily: "'Cormorant Garamond', serif" }}
                    >
                      {post.excerpt}
                    </p>
                    <Link
                      to={`/blog/${post.slug}`}
                      className="inline-flex items-center gap-1.5 text-[11px] font-semibold uppercase tracking-[0.14em] text-[#1A3A28] transition-colors hover:text-[#B08A3A]"
                      style={{ fontFamily: "'Montserrat', sans-serif" }}
                    >
                      Read More
